    ...
    if(!empty($user) && !empty($pass) && !empty($usertype)){
        ...
        if($res->num_rows){
            ...
            if(!empty($profile) && !empty($profile2)){
                $insert  = "INSERT INTO tbl_users (`username`, `password`, user_type, barangay, avatar) VALUES ('$user', '$pass', '$usertype', '$barangay', '$profile')";
                ...
                $insert  = "INSERT INTO tbl_users (`username`, `password`, user_type, barangay, avatar) VALUES ('$user', '$pass', '$usertype', '$barangay', '$newName')";
                $result  = $conn->query($insert);
