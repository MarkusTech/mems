...
<?php 
    ...
    if($state=='fire'){
        $query = "SELECT * FROM tblincident WHERE incident = 'Fire'";
        $result = $conn->query($query);
    }elseif($state=='flood'){
        $query = "SELECT * FROM tblincident WHERE incident = 'Flood'";
        $result = $conn->query($query);
    }elseif($state=='landslide'){
        $query = "SELECT * FROM tblincident WHERE incident = 'Landslide'";
        $result = $conn->query($query);
    }elseif($state=='Vehicular'){
        $query = "SELECT * FROM tblincident WHERE incident = 'Vehicular'";
        $result = $conn->query($query);
    }elseif($state=='BigWaves'){
        $query = "SELECT * FROM tblincident WHERE incident = 'BigWaves'";
        $result = $conn->query($query);
    }elseif($state=='Others'){
        $query = "SELECT * FROM tblincident WHERE incident = 'Others'";
        $result = $conn->query($query);
    }else{
