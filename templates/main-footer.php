<footer class="footer">
    <div class="container-fluid">
        <div class="copyright ml-auto">
            2022 &copy Disaster and Risk Reduction Management
        </div>				
    </div>
</footer>

<!-- Modal -->
<div class="modal fade" id="systeminfo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="model/edit_system_info.php" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Enter System Name" name="brgy" required value="<?= $brgy ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
