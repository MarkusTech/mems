...
// get Users
$query = "SELECT members,firstname,middlename,lastname,relationship,age,civilstatus,gender,occupation,income,dependents,child,senior,housecondition,contact,outside,inside,amountdamage,housingstatus,incident,barangay FROM tblincident WHERE barangay = 'Fatima'";
